...
# * 安裝 PHP Extensions
sudo apt-get install -y php${PHP_VERSION}-curl php${PHP_VERSION}-mbstring php${PHP_VERSION}-xml php${PHP_VERSION}-intl php${PHP_VERSION}-gd php${PHP_VERSION}-bcmath
sudo apt-get install -y php${PHP_VERSION}-sqlite3 php${PHP_VERSION}-mysql php${PHP_VERSION}-pgsql php${PHP_VERSION}-redis
sudo apt-get install -y php${PHP_VERSION}-zip php${PHP_VERSION}-xml php${PHP_VERSION}-gd
